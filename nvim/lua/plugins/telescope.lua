...
local rg_ignore_args = {
  ...
  "--glob", "!*.pdf", "--glob", "!*.doc", "--glob", "!*.docx",
  "--glob", "!*.ppt", "--glob", "!*.pptx", "--glob", "!*.xls", "--glob", "!*.xlsx",
  "--glob", "!*.odt", "--glob", "!*.ods", "--glob", "!*.odp",
  "--glob", "!*.rtf", "--glob", "!*.epub",
  "--glob", "!*.zip", "--glob", "!*.7z", "--glob", "!*.tar", "--glob", "!*.gz",
  "--glob", "!*.tgz", "--glob", "!*.bz2", "--glob", "!*.xz", "--glob", "!*.rar", "--glob", "!*.zst",
  "--glob", "!*.iso", "--glob", "!*.dmg",
  "--glob", "!*.bin", "--glob", "!*.jar", "--glob", "!*.apk", "--glob", "!*.ipa",
  "--glob", "!*.deb", "--glob", "!*.rpm",
  "--glob", "!*.db", "--glob", "!*.sqlite", "--glob", "!*.sqlite3",
  "--glob", "!*.p12", "--glob", "!*.pfx",
}
